...
class InMemoryTeamEligibilityRepository:
    def __init__(self) -> None:
        self._eligibility: dict[tuple[str, str], TeamEligibility] = {}
    ...
    def get(self, team_id: str, member_id: str) -> TeamEligibility | None:
        return self._eligibility.get((team_id, member_id))

    def add(self, eligibility: TeamEligibility) -> TeamEligibility:
        self._eligibility[(eligibility.team_id, eligibility.member_id)] = eligibility
        return eligibility

    def delete(self, team_id: str, member_id: str) -> None:
        self._eligibility.pop((team_id, member_id), None)
